from core.util import csvLines
...
class TestCsvLinesPop:
    ...
    def test_pop_consumes_all_lines(self):
        ...
        assert(not self.log.ready())
        assert(self.log["Item1"] is None)
        assert(self.log["Item2"] is None)
