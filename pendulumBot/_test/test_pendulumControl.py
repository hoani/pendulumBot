from pendulumBot.control import pendulum
from pendulumBot._test.fake.bot import ahrsFake
from pendulumBot._test.fake.control import pidFake
...
class TestPendulumSetEnable:
  ...
  def test_set_enable(self):
    ...
    assert(self.ctrl.enable == True)

  def test_set_disable(self):
    self.ctrl.set_enable(False)
    assert(self.ctrl.enable == False)
  ...
  def test_resets_pid_on_enable(self):
    self.ctrl.set_enable(True)
    assert(self.pid.reset_called == True)
...
class TestPendulumUpdateSimple:
  ...
  def test_gets_ahrs_values(self):
    ...
    assert(self.ahrs.update_called == False)
    assert(self.ahrs.get_called == True)
  ...
  def test_updates_pid(self):
    ...
    assert(self.pid.update_called == True)
  ...
  def test_no_updates_when_disabled(self):
    ...
    assert(self.ahrs.get_called == False)
    assert(self.pid.update_called == False)
