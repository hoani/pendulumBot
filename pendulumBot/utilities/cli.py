...
def get_args(default_settings):
  ...
  parser = argparse.ArgumentParser(description='A two-wheeled pendulum robot controller')
  parser.add_argument(
    '--bluetooth', 
  ...
  parser.add_argument(
    ...
    default=[default_settings["tcp"]["address"], default_settings["tcp"]["port_command"], default_settings["tcp"]["port_log"]],
