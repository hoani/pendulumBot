...
class TestGetPacketDecode():
  ...
  def test_multi_packet_decoding(self):
    expected = codec.Packet("get", "protocol/version", tuple([0x11, 0x22, 0x3344]))
...
class TestSetPacketDecodeMultiple():
  ...
  def test_sequential(self):
    expected = codec.Packet("set", "protocol/version", tuple([0x12, 0x34, 0x567]))
  ...
  def test_non_sequential(self):
    expected = codec.Packet("set", "protocol", tuple([0x12, 0x34, 0x567, "Hoani"]))
  ...
  def test_ignores_unused_sequential_items(self):
    expected = codec.Packet("set", "protocol/version", tuple([0x12, 0x34]))
...
class TestSetPacketDecodeSingle():
  ...
  def test_simple_string(self):
    expected = codec.Packet("set", "typecheck/string", tuple(["Hoani's String"]))
  ...
  def test_simple_bool(self):
    expected = codec.Packet("set", "typecheck/boolean", tuple([True]))
  ...
  def test_simple_u8(self):
    expected = codec.Packet("set", "typecheck/uint8", tuple([0xa5]))
  ...
  def test_underflow_u8(self):
    expected = codec.Packet("set", "typecheck/uint8", tuple([0x00]))
  ...
  def test_overflow_u8(self):
    expected = codec.Packet("set", "typecheck/uint8", tuple([0xff]))
  ...
  def test_simple_u16(self):
    expected = codec.Packet("set", "typecheck/uint16", tuple([0x0234]))
  ...
  def test_underflow_u16(self):
    expected = codec.Packet("set", "typecheck/uint16", tuple([0x0000]))
    result = self.codec.decode(("S2004:-0234\n").encode('utf-8'))
    assert(result.category == expected.category)
    assert(result.path == expected.path)
    assert(result.payload == expected.payload)
  ...
  def test_overflow_u16(self):
    expected = codec.Packet("set", "typecheck/uint16", tuple([0xffff]))
  ...
  def test_simple_u32(self):
    expected = codec.Packet("set", "typecheck/uint32", tuple([0x102234]))
  ...
  def test_underflow_u32(self):
    expected = codec.Packet("set", "typecheck/uint32", tuple([0x00000000]))
    result = self.codec.decode(("S2005:-00102234\n").encode('utf-8'))
    assert(result.category == expected.category)
    assert(result.path == expected.path)
    assert(result.payload == expected.payload)
  ...
  def test_overflow_u32(self):
    expected = codec.Packet("set", "typecheck/uint32", tuple([0xffffffff]))
  ...
  def test_simple_u64(self):
    expected = codec.Packet("set", "typecheck/uint64", tuple([0x10223400000078]))
  ...
  def test_underflow_u64(self):
    expected = codec.Packet("set", "typecheck/uint64", tuple([0x0]))
  ...
  def test_overflow_u64(self):
    expected = codec.Packet("set", "typecheck/uint64", tuple([0xffffffffffffffff]))
  ...
  def test_simple_i8(self):
    expected = codec.Packet("set", "typecheck/int8", tuple([0x11]))
  ...
  def test_simple_i16(self):
    expected = codec.Packet("set", "typecheck/int16", tuple([0x0234]))
  ...
  def test_simple_i32(self):
    expected = codec.Packet("set", "typecheck/int32", tuple([0x102234]))
  ...
  def test_simple_i64(self):
    expected = codec.Packet("set", "typecheck/int64", tuple([0x10223400000078]))
  ...
  def test_float(self):
    expected = codec.Packet("set", "typecheck/float", tuple([1.2717441261e+20]))
  ...
  def test_double(self):
    expected = codec.Packet("set", "typecheck/double", tuple([1.2344999999999999307]))
